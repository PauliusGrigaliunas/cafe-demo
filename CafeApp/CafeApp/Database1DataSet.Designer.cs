...
namespace CafeApp {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsersRow AddUsersRow(int User_Id, string Email, string Password, string Name, string Surname) {
...
namespace CafeApp.Database1DataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([User Id] = @Original_User_Id) AND ([Password] " +
                "= @Original_Password))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([User Id], [Email], [Password], [Name], [Surname]) VAL" +
                "UES (@User_Id, @Email, @Password, @Name, @Surname);\r\nSELECT [User Id], Email, Pa" +
                "ssword, Name, Surname FROM Users WHERE ([User Id] = @User_Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [User Id] = @User_Id, [Email] = @Email, [Password] = @Password, [Name] = @Name, [Surname] = @Surname WHERE (([User Id] = @Original_User_Id) AND ([Password] = @Original_Password));
SELECT [User Id], Email, Password, Name, Surname FROM Users WHERE ([User Id] = @User_Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CafeApp.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [User Id], Email, Password, Name, Surname FROM dbo.Users";
        ...
        public virtual int Delete(int Original_User_Id, string Original_Password) {
        ...
        public virtual int Insert(int User_Id, string Email, string Password, string Name, string Surname) {
        ...
        public virtual int Update(int User_Id, string Email, string Password, string Name, string Surname, int Original_User_Id, string Original_Password) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Email, string Password, string Name, string Surname, int Original_User_Id, string Original_Password) {
            return this.Update(Original_User_Id, Email, Password, Name, Surname, Original_User_Id, Original_Password);
        }
    }
